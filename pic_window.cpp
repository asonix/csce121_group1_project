...
{													// 21 lines w/o comments
	// Buttons
	Window::attach(quit_button); Window::detach(quit_button);
	Window::attach(back1_button); Window::detach(back1_button);
	Window::attach(back2_button); Window::detach(back2_button);
	Window::attach(gallery_button); Window::detach(gallery_button);
	Window::attach(add_button); Window::detach(add_button);
	Window::attach(left_button); Window::detach(left_button);
	Window::attach(right_button); Window::detach(right_button);
	Window::attach(del_button); Window::detach(del_button);
	Window::attach(search_button); Window::detach(search_button);
	Window::attach(download_button); Window::detach(download_button);
	Window::attach(addpic_button); Window::detach(addpic_button);
	// In boxes
